...
class Department extends \App\Entities\Department implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Department' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Department' . "\0" . 'fullName', '' . "\0" . 'App\\Entities\\Department' . "\0" . 'abbreviation', '' . "\0" . 'App\\Entities\\Department' . "\0" . 'specialities'];
        }
