    ...
    <div class="container grey-light page-height-default">
        ...
        <div class="p-t">
            ...
            <md-dialog :md-active.sync="toggleModalAdd" class="pl-5 pr-5 of-auto" md-scrollbar>
                <md-dialog-title class="fb-center">Добавить факультет</md-dialog-title>
                ...
                <div class="buttons pb-3">
                    <md-button class="md-primary md-raised" @click="createFaculty()">Сохранить</md-button>
            ...
            <md-dialog :md-active.sync="toggleModalEdit" class="pl-5 pr-5 of-auto" md-scrollbar>
                <md-dialog-title class="fb-center">Изменить факультет</md-dialog-title>
                <div class="pl-2 pr-2 pb-3">
                    <md-field>
                        <label>Наименование</label>
                ...
                <div class="buttons pb-3">
                    <md-button class="md-primary md-raised" @click="editFaculty()">Сохранить</md-button>
            ...
            <md-card>
                ...
                <md-card-content>
                    <div class="buttons">
                        ...
                        <md-button class="md-icon-button md-dense md-raised md-primary upd-icon" @click="getFaculties()">
    ...
    export default {
        ...
        methods: {
            ...
            getAlternateLabel (count) {
                ...
                return `Выделен${plural2} ${count} факультет${plural}`;
            },
            searchOnTable () {
            ...
            deleteFaculties: function() {
                axios
                    .post('/deleteFaculties', {
