    ...
    <div class="container grey-light page-height-default" :style="secondStyle">
        ...
        <div class="p-t">
            ...
            <md-dialog :md-active.sync="toggleModalAdd" class="pl-5 pr-5 of-auto" md-scrollbar>
                <md-dialog-title class="fb-center">Добавить специальность</md-dialog-title>
                ...
                <div class="buttons pb-3">
                    <md-button :style="primaryStyle" class="md-primary md-raised" @click="createSpeciality()">Сохранить</md-button>
            ...
            <md-dialog :md-active.sync="toggleModalEdit" class="pl-5 pr-5 of-auto" md-scrollbar>
                <md-dialog-title class="fb-center">Изменить специальность</md-dialog-title>
                <div class="pl-2 pr-2 pb-3">
                    <md-field>
                        <label>Наименование</label>
                ...
                <div class="buttons pb-3">
                    <md-button :style="primaryStyle" class="md-primary md-raised" @click="editSpeciality()">Сохранить</md-button>
            ...
            <md-card>
                ...
                <md-card-content>
                    <div class="buttons">
                        ...
                        <md-button :style="primaryStyle" class="md-icon-button md-dense md-raised md-primary upd-icon" @click="getSpecialities()">
                ...
                <md-table v-model="searched" md-card md-sort="id" md-sort-order="asc" md-fixed-header @md-selected="onSelect" :md-selected-value.sync="selected">
                    ...
                    <md-table-empty-state
                        ...
                        :md-description="'Не было найдено ни одной специальности. Измените запрос или создайте новую специальность.'">
    ...
    export default {
        ...
        methods: {
            ...
            getAlternateLabel (count) {
                ...
                return `Выделен${plural2} ${count} специальност${plural}`;
            },
            searchOnTable () {
            ...
            deleteSpecialities: function() {
                axios
                    .post('/deleteSpecialities', {
