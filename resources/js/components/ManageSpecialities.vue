        ...
        <div class="p-t">
            ...
            <md-dialog :md-active.sync="toggleModalAdd" class="pl-5 pr-5 of-auto" md-scrollbar>
                ...
                <div class="buttons pb-3">
                    <md-button  class="md-primary md-raised" @click="createSpeciality()">Сохранить</md-button>
            ...
            <md-dialog :md-active.sync="toggleModalEdit" class="pl-5 pr-5 of-auto" md-scrollbar>
                ...
                <div class="buttons pb-3">
                    <md-button  class="md-primary md-raised" @click="editSpeciality()">Сохранить</md-button>
            ...
            <md-card>
                ...
                <md-card-content>
                    <div class="buttons">
                        ...
                        <md-button  class="md-icon-button md-dense md-raised md-primary upd-icon" @click="getSpecialities()">
